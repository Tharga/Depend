...
public class PathService : IPathService
{
    ...
    public static void EnsureInUserPath()
    {
        ...
        if (pathSegments.Contains(exePath, StringComparer.OrdinalIgnoreCase))
            return;
        ...
        Console.WriteLine($"✅ Added '{exePath}' to user PATH. You can now run this tool from anywhere.");
        Console.ResetColor();
    }
}